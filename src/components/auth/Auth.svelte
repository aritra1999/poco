...
{:else}
    <button class="flex items-center rounded-md py-2.5 px-4 hover:bg-gradient-to-r hover:from-blue-500 hover:via-blue-600 hover:to-blue-700 hover:text-white">
        {#if $meta.screen == 'desktop'}<div class="mr-4">signin</div>{/if}
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" width="32" height="32" viewBox="0 0 16 16">
